...
void PrintMenu(void){
  ...
  fprintf(stderr,
  "NAME                                                                    \n"
  "      EAGLE v%u.%u 2013-2021                                            \n"
  "      Efficient computation of minimal Relative Absent                  \n"
  "      Words (mRAWs) and its associated distributions,                   \n"
  "      profiles, and patterns for DNA/RNA and Amino Acids                \n"
  "      sequences.                                                        \n"
  "                                                                        \n"
  "AUTHORS                                                                 \n"
  ...
  "      Absent Words (mRAWs) and associated measures                      \n"
  "                                                                        \n"
  "      -h,  --help                                                       \n"
  ...
  "                                                                        \n"
  "      -g,  --ignore-gc-profiles                                         \n"
  "           does NOT compute GC profiles                                 \n"
  "                                                                        \n"
  "      -r,  --ignore-raw-profiles                                        \n"
  "           does NOT compute mRAWs profiles                              \n"
  "                                                                        \n"
  "      -s,  --ignore-splitted-files                                      \n"
  "           does NOT remove spitted files                                \n"
  "                                                                        \n"
  "      -o,  --stdout                                                     \n"
  ...
  "                                                                        \n"
  "COPYRIGHT                                                               \n"
  "      Copyright (C) 2013-2021, IEETA/DETI, University of Aveiro.        \n"
...
void PrintVersion(void){
  ...
  "ANY WARRANTY, to the extent permitted by law. Email: pratas [at] ua.pt  \n"
  "                                                                        \n", 
  VERSION, RELEASE);
  }
